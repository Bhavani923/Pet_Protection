...
<head>
	...
	<link rel="stylesheet" type="text/css" href="dogselection.css">
...
<body">
    <div class="bodyt">
		<div class="logo">
			<ul>
				<li><h1 style=><img src="images/imageL.png" ></h1></li>
				<li></li>
				<li class="a"><a href="#">
	...
	<div class="wrapper">
		<h1 style="font-style: italic; font-size: 1.5rem;color: rgb(231, 224, 227);">I'm here Adopt me:)!!<h1>	
	</div>

	<div class="selectPet1">
		<ul>
		<li><button>
            <div class="header"><h5 style=" font-size: 25px; color: rgb(240, 215, 215);"> your dog</h5></div>
        </button>
	...
	<!--	<label for="formate3">Select Age</label><br/></br>-->
		<select class="format" id="formate3">
			...
			<option class="yes" value="name">Dog</option>
			<option class="yes" value="name">Puppy</option>
		</select></li>
	...
	<div class="search_btn">
			<button type="button" >
				<a href="toselectdog.php">Search</a>
			</button>
	</div>
</div>
</body>
